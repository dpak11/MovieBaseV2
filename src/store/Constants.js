...
export const GET_VALUES = {API_CALLS_NUM, API_KEY_MOVIE,LANG_MOVIE_US,MOVIE_API,MOVIEDB_URL,MOVIE_DETAIL,MOVIE_DISCOVER,GENRE_LIST,THUMBNAIL_PATH,TOP_RATED_MOVIE}
